...
document.addEventListener("DOMContentLoaded", function () {
  const dropdowns = [
    {
      button: "header-games-btn",
      menu: "header-games-menu",
      visibleClass: "games-visible",
      chevron: "chevron-games",
    },
    {
      button: "header-experiences-btn",
      menu: "header-experiences-menu",
      visibleClass: "experiences-visible",
      chevron: "chevron-experiences",
    },
    {
      button: "header-about-btn",
      menu: "header-about-menu",
      visibleClass: "about-visible",
      chevron: "chevron-about",
    },
    {
      button: "header-commitments-btn",
      menu: "header-commitments-menu",
      visibleClass: "commitments-visible",
      chevron: "chevron-commitments",
    },
    {
      button: "header-resources-btn",
      menu: "header-resources-menu",
      visibleClass: "resources-visible",
      chevron: "chevron-resources",
    },
  ];
...
function updateImage() {
  ...
  if (window.innerWidth <= 768) {
    ...
    img.src =
      "https://media.contentapi.ea.com/content/dam/ea/tales-of-kenzera/zau/images/2023/12/talesofkenzera-hero-md-franchisehub-tophero-7x2-xl-newest.jpg.adapt.crop7x2.1920w.jpg";
  }
}
